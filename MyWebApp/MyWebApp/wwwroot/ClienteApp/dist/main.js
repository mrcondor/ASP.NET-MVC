...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_servicos_dataService__WEBPACK_IMPORTED_MODULE_5__["DataService"]],
...
var Carrinho = /** @class */ (function () {
    ...
    Carrinho = __decorate([
        ...
        __metadata("design:paramtypes", [_servicos_dataService__WEBPACK_IMPORTED_MODULE_1__["DataService"]])
    ], Carrinho);
    return Carrinho;
}());
...
var EfetivarCompra = /** @class */ (function () {
    ...
    EfetivarCompra.prototype.onEfetivarCompra = function () {
        ...
        this.data.efetivarCompra()
            ...
            _this.mensagem = "Falhar ao salvar pedido";
        });
    };
    EfetivarCompra = __decorate([
        ...
        __metadata("design:paramtypes", [_servicos_dataService__WEBPACK_IMPORTED_MODULE_1__["DataService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], EfetivarCompra);
...
/***/ "./ClienteApp/app/modelos/pedido.ts":
/*!******************************************!*\
  !*** ./ClienteApp/app/modelos/pedido.ts ***!
  \******************************************/
...
/* harmony import */ var _modelos_pedido__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modelos/pedido */ "./ClienteApp/app/modelos/pedido.ts");
...
var DataService = /** @class */ (function () {
    function DataService(http) {
        this.http = http;
        this.pedido = new _modelos_pedido__WEBPACK_IMPORTED_MODULE_1__["Pedido"]();
    }
    DataService.prototype.carregarProdutos = function () {
        var _this = this;
        return this.http.get("/api/produto").map(function (result) { return _this.produtos = result.json(); });
    };
    DataService.prototype.adicionarProduto = function (produto) {
        ...
        if (itemSelecionado) {
            ...
            var item = void 0;
            item = new _modelos_pedido__WEBPACK_IMPORTED_MODULE_1__["ItemPedido"]();
    ...
    DataService.prototype.efetivarCompra = function () {
        ...
        return this.http.post("/api/pedido", this.pedido)
            ...
            _this.pedido = new _modelos_pedido__WEBPACK_IMPORTED_MODULE_1__["Pedido"]();
            return true;
        });
    };
...
module.exports = __webpack_require__(/*! D:\Estudos\AspNetMVC\MyWebApp\MyWebApp\ClienteApp\main.ts */"./ClienteApp/main.ts");
